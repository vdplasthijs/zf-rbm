...
#%% General options:
num_threads = 32  # Set number of CPUs to use!
save_weights = True
generate_data = True
...
time_cutoff_start, time_cutoff_end = 0, 4000  # cut off point for training (ie. only time points upto time_cutoff are used for training, others can be used for evaluation post hoc )
